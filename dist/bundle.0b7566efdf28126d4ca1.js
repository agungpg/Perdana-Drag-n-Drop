...
function onCardDrag(ce) {
  timeoutDrag = setTimeout(() => {
    ...
    if (_index__WEBPACK_IMPORTED_MODULE_0__.PerdanaDnDMultipleData.onDragStartCb)
      _index__WEBPACK_IMPORTED_MODULE_0__.PerdanaDnDMultipleData.onDragStartCb(boardIndex, cardIndex);
...
function onCardDrop() {
  ...
  if (_index__WEBPACK_IMPORTED_MODULE_0__.PerdanaDnDMultipleData.cardActiveElement) {
    ...
    if (_index__WEBPACK_IMPORTED_MODULE_0__.PerdanaDnDMultipleData.onDragEndCb)
      _index__WEBPACK_IMPORTED_MODULE_0__.PerdanaDnDMultipleData.onDragEndCb(
...
/* harmony export */   reRenderBoards: () => (/* binding */ reRenderBoards),
...
function reRenderBoards(boardIndexes) {
  _index__WEBPACK_IMPORTED_MODULE_0__.PerdanaDnDMultipleData.data.forEach((bdata, bIndex) => {
    ...
    _index__WEBPACK_IMPORTED_MODULE_0__.PerdanaDnDMultipleData.container.children[bIndex].remove();
    if (bIndex > 0) {
      _index__WEBPACK_IMPORTED_MODULE_0__.PerdanaDnDMultipleData.container.children[bIndex - 1].after(board);
    } else {
      _index__WEBPACK_IMPORTED_MODULE_0__.PerdanaDnDMultipleData.container.children[bIndex].before(board);
    }
  });
}
...
/******/ })()
;
//# sourceMappingURL=bundle.0b7566efdf28126d4ca1.js.map